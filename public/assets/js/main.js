    ...
    var rtsJs = {
      ...
      modal: function() {
        $(document).ready(function() {
          $('#loginModal, #signupModal').on('click', function() {
              var modalId = $(this).attr('id') === 'loginModal' ? '#loginmodal' : '#registerModal';
              $(modalId).addClass('inset-0').css('display', 'flex');
          ...
          $(document).on('click', function(e) {
              if (!$(e.target).closest('.relative').length && !$(e.target).is('#loginModal, #signupModal')) {
                  closeModal();
              }
          });
          ...
          function closeModal() {
              $('.fixed').removeClass('inset-0').css('display', 'none');
          }
      ...
      mobileMenu: function (e) {
        $(document).ready(function () {
          $("#menu__btn, #desktop__btn, #desktop__btn i").on("click", function () {
