...
const CommunicationsIndex = ({ templates, campaigns, availableVariables, flash }) => {
    ...
    const UserOption = ({ innerRef, innerProps, data, isSelected, isFocused }) => (
        <div
            ref={innerRef}
            {...innerProps}
            className={`
    ...
    const UserValue = ({ children, ...props }) => (
    ...
    const addCustomRecipient = () => {
        ...
        const updatedRecipients = [...formData.custom_recipients, { ...newCustomRecipient }];
        setFormData({
            ...formData,
            custom_recipients: updatedRecipients
        });
        setNewCustomRecipient({ name: '', email: '', phone: '' });
    };

    const removeCustomRecipient = (index) => {
        const updatedRecipients = formData.custom_recipients.filter((_, i) => i !== index);
        setFormData({
            ...formData,
            custom_recipients: updatedRecipients
        });
    ...
    const handleImportCSV = () => {
        ...
        const updatedRecipients = [...formData.custom_recipients, ...importedRecipients];
        setFormData({
            ...formData,
            custom_recipients: updatedRecipients
        });
    ...
    // Custom Recipients Section Component
    const CustomRecipientsSection = () => (
            ...
            <div className="flex justify-between items-center">
                ...
                <div className="flex gap-2">
                    <span className="text-sm text-gray-500">
                        {formData.custom_recipients.length} recipients
                    </span>
                    <button
                        type="button"
            ...
            <div className="bg-gray-50 p-4 rounded-lg">
                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-3">
                    <div>
                        ...
                        <input
                            type="text"
                            value={newCustomRecipient.name}
                            onChange={(e) => setNewCustomRecipient({
                                ...newCustomRecipient,
                                name: e.target.value
                            })}
                    ...
                    <div>
                        ...
                        <input
                            type="email"
                            value={newCustomRecipient.email}
                            onChange={(e) => setNewCustomRecipient({
                                ...newCustomRecipient,
                    ...
                    <div>
                        ...
                        <input
                            type="text"
                            value={newCustomRecipient.phone}
                            onChange={(e) => setNewCustomRecipient({
                                ...newCustomRecipient,
                    ...
                    <div className="flex items-end">
                        <button
                            ...
                            disabled={!newCustomRecipient.name.trim() || (!newCustomRecipient.email && !newCustomRecipient.phone)}
        ...
        <div className="space-y-4">
            <div>
                ...
                <Select
                    ...
                    onChange={(selectedOptions) => setIndividualFormData({
                        ...individualFormData,
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    onChange={(e) => setIndividualFormData({
                                                        ...individualFormData,
