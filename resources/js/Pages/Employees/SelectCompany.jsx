            ...
            <div className="flex items-center space-x-4">
                {!previews[field] && (
                    ...
                    <label 
                        ...
                        className="cursor-pointer flex items-center px-4 py-2 bg-blue-peach text-white rounded-md hover:bg-blue-600 transition-colors"
                    >
            ...
            <div className="relative py-3 sm:max-w-xl sm:mx-auto w-full px-4">
                ...
                <div className="relative bg-white shadow-lg sm:rounded-3xl p-6">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            className="w-full bg-blue-600 text-white py-3 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-peach transition-colors"
                        >
                            Send
                        </button>
                    </form>
