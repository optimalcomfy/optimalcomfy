      ...
      <div>
        ...
        <div className="mt-2 flex flex-col items-center">
          ...
          <label
            ...
            className="mt-4 px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-peach cursor-pointer"
          >
            ...
            <div className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-peach"
                />
              </div>
              <div>
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="flex gap-4">
                  <input
                    ...
                    placeholder="Min"
                    className="w-1/2 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-peach"
                  />
                  <input
                    type="number"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-peach min-h-[100px]"
                />
              </div>
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-peach min-h-[150px]"
                />
              </div>
            </div>
          )}
          ...
          <div className="flex justify-between mt-6">
            {step > 1 && (
              <button
                ...
                className="px-4 py-2 text-sm font-medium text-gray-700 bg-gray-100 border border-gray-300 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-peach"
              >
                Previous
              </button>
            )}
            ...
            {step < 5 &&
              <button
                type="button"
                onClick={() => setStep(step + 1)}
                className="ml-auto px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-md hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-peach"
              >
                Next
              </button>
            }
