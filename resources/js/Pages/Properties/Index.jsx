  ...
  return (
    <Layout>
      <div className="w-full mr-auto p-6 rounded-lg shadow-md">
        <h1 className="text-lg font-bold mb-4">Stays</h1>
        <Link href={route("properties.create")} className="mb-4 inline-block bg-blue-peach text-white px-4 py-2 rounded bg-peachDark">
          Add a stay
        </Link>
        <table className="w-full border-collapse border">
          <thead>
            <tr className="bg-gray-200">
              <th className="border px-4 py-2">Stay Name</th>
            ...
            {properties.map(property => (
              <tr key={property.id}>
                ...
                <td className="border px-4 py-2">
                  <Link href={route("properties.show", property.id)} className="text-blue-peach mr-2">View</Link>
