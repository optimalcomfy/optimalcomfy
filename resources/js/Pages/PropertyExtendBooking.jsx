...
import '../../css/main';
import PropertyExtendPayForm from "@/Components/PropertyExtendPayForm";

export default function PropertyExtendBooking({ auth, laravelVersion, phpVersion, extension_data }) {
                ...
                <div className="container lg:py-24">
                  <div className="row align-items-center">
                    <div className="col-lg-12 xs:-mt-4 lg:-mt-20 sm-mt-0">
                      ...
                      >
                        <PropertyExtendPayForm extension_data={extension_data} />
                      </div>
                    </div>
                  </div>
                </div>
