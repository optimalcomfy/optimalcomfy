...
export default function Rooms({ auth, laravelVersion, phpVersion }) {
        ...
        <LayoutProvider>
          ...
          <>
            ...
            >
                ...
                <p className="text-sm">
                Discover elegantly designed rooms with breathtaking views, premium amenities, and a touch of sophistication for your perfect stay.
                </p>
                {/* advance form */}
                        ...
                        {rooms && rooms.map((data, index)=>{
                            ...
                            <div className="overflow-hidden rounded-[10px] max-w-full border-[1px] border-solid border-[#F1F1F1]" key={index}>
                                ...
                                <div className="relative p-[30px] pt-[20px]">
                                     <Link
                                    href={route('room-detail', { id: data.id })} className="heading h5 text-heading">
                                    {data?.room_number} - {data.type}
                                    </Link>
