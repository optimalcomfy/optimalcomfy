  ...
  return (
    <Layout>
      <div className="w-full mr-auto bg-white p-6 rounded-lg shadow-md">
        ...
        <Link href={route("services.create")} className="mb-4 inline-block bg-peach text-white px-4 py-2 rounded">
          Add Service
        </Link>
            ...
            {services.map(service => (
              <tr key={service.id}>
                ...
                <td className="border px-4 py-2">
                  <Link href={route("services.show", service.id)} className="text-peach mr-2">View</Link>
