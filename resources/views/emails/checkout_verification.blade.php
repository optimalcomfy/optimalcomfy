    ...
    <div class="email-container">
        <div class="content">
            ...
            <h2 class="farewell-text">
                ...
                <span class="property-name">{{ $booking->property->property_name }}</span>
                is ready!
            </h2>
        ...
        <div class="footer">
            <p class="footer-message">
                We're delighted to have provided you with an exceptional stay experience.
            </p>
            
            <div class="return-message">
                <strong>Come back soon!</strong> We'd love to welcome you again for another amazing stay.
            </div>
